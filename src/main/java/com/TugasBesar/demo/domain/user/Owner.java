...
public final class Owner extends User {
	private static final Set<String> MENUS = Set.of(
			"dashboard", "products", "stock", "suppliers", "purchases", "users");

	public Owner(int id, String name, String username, String email) {
	...
	protected Set<AppScope> allowedScopes() {
		return Set.of(AppScope.OWNER, AppScope.INVENTORY);
	}
}
